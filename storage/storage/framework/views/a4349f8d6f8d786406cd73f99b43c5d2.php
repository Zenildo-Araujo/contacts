...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <div class="card">
            ...
            <a class="btn btn-sm btn-success" href=<?php echo e(URL('/contact/create')); ?>>Add Contact</a>
            <a class="btn btn-sm btn-success" href=<?php echo e(URL('/contacts/show_all')); ?>>Show All</a>
            </div>
...
<?php echo $__env->make('auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/auth/index.blade.php ENDPATH**/ ?>